...
Konwerter jednostek to prosta aplikacja umożliwiająca przeliczanie podstawowych jednostek miary. Program pozwala na konwersję jednostek w trzech kategoriach:
- waga
- długość
- temperatura
